...
class DetailedLoggingCallback(Callback):
    def __init__(self, test_data, file_prefix="MobileNet_v3_v3_optAdam_lr0.001_bs32"):
...
# Khởi tạo callback early stopping
early_stopping_callback = EarlyStopping(
    monitor="loss",  # Đo lường dựa trên sự thay đổi của training loss
    patience=10,  # Số lượng epochs không có cải thiện mà bạn chấp nhận trước khi dừng huấn luyện
...
model.save("./MobileNet_v3_v3.keras")
